...
def guess_the_number():
	...
	ui.game_show_intro(description, intro)
	secret_number = random.randint(1, 100)
	attempts = ui.game_play_game(secret_number)
...
def input_demo():
	...
	ret_value = ui.get_input_demo("string", description)
	ui.display_message(f"You entered {ret_value}", False, True)
	ret_value = ui.get_input_demo("int", description)
	ui.display_message(f"You entered {ret_value}", False, True)
	ret_value = ui.get_input_demo("real", description)
	ui.display_message(f"You entered {ret_value}", False, True)
	ret_value = ui.get_input_demo("bool", description)
...
def main():
	ui.set_console(80, 25, "white", "black", True) #set to default size 80 x 25, white text on black bg 
	quit = False
